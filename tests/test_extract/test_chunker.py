"""Tests for scholarforge.extract.chunker."""

from __future__ import annotations

from unittest.mock import patch

from scholarforge.extract.chunker import _split_into_sections, chunk_sections
...
def test_chunk_sections_chunk_index_ordered():
    ...
    with patch("scholarforge.extract.chunker.settings") as mock_settings:
