...
- **`dossier.md`** — the primary evidence artifact for the writer.
  ...
  it also includes a Figure candidates section, and — when the claim
  store has verified numbers from this page's chunks — an **Available
  data** table; cite a value with the marker shown for it. Generated by
  `wikify draft build`, regenerated each rebuild.
