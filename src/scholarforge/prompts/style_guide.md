...
- **No meta-commentary.** Never write a sentence whose grammatical subject is "this review," "this section," "the sections above/below," or equivalent, where the predicate describes what the document does rather than what the field shows. This ban applies to all verbs, not a fixed list. BAD: "This review organizes the literature around four gaps." BAD: "Each section closes by identifying the missing experiment." GOOD: Just begin with content about what the field knows.
...
- **Abstract sentence order**: (1) accessible context — what problem the field faces and why it matters, readable by a non-specialist; (2) the most important or surprising observation — which may be an inter-field connection, a contradiction, a convergence, or the field's most critical unresolved tension; (3) key evidence with specifics; (4) what the reader now understands or can do. Never lead sentence 1 with a technical claim; context always comes first. Sentence 2 should reflect what the corpus actually offers — do not impose an inter-field framing if the corpus does not support it.
...
- **Section continuity.** Each section must open with a sentence naming something concrete from the previous section's closing before introducing the new topic. BAD: "Array integration presents additional challenges." GOOD: "The filament nucleation variability described above is amplified at array scale — sneak-path currents compound single-device scatter into yield loss." Close each section with a sentence that creates a logical need for what comes next; the reader should never be surprised by a section change.
