...
from wikify.generate.verifier import verify_paper, verify_section_against_plan
...
if TYPE_CHECKING:
    from wikify.export.journal_profile import JournalProfile
    from wikify.retrieve.context import SectionContext
