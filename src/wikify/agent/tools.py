...
def search_papers(
    ...
    try:
        ...
        # Log this search
        if reason:
            from wikify.agent.reading_log import get_reading_log
...
def suggest_next_papers(
    ...
    try:
        ...
        from wikify.evaluate.coverage import compute_paper_vibes
...
def get_coverage_gaps(
    ...
    try:
        ...
        from wikify.evaluate.coverage import compute_coverage
        from wikify.store.db import get_session
        from wikify.store.models import Paper
...
def find_jump_target(
    ...
    try:
        ...
        from wikify.evaluate.coverage import compute_coverage, compute_paper_vibes
        from wikify.graph.metrics import build_corpus_graph
...
def get_frontier_exploration_order(max_papers: int = 15) -> str:
    ...
    """
    try:
        from wikify.evaluate.frontier import (
...
def get_paper_vibes(top_k: int = 5) -> str:
    ...
    """
    try:
        from wikify.evaluate.coverage import compute_paper_vibes, vibe_map_for_llm
